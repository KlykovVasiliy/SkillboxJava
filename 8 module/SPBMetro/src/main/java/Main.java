    ...
    private static void parseConnections(JSONArray connectionsArray) {
        connectionsArray.forEach(connectionObject ->
        {
            ...
            connection.forEach(item ->
            {
                ...
                int lineNumber = ((Long) itemObject.get("line")).intValue();                        //номер линии
                String stationName = (String) itemObject.get("station");                            //имя станции

                Station station = stationIndex.getStation(stationName, lineNumber);                 //получение станции
                if (station == null) {
                    throw new IllegalArgumentException("core.Station " +
                            stationName + " on line " + lineNumber + " not found");
                }
                connectionStations.add(station);                                                    //добавление станции в список пересадок
            });
